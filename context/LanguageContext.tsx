...
export const translations = {
  ...
  ar: {
    ...
    hero_desc_part3: "، نبتكر حلولاً برمجية ذكية ونحول البيانات المعقدة إلى رؤى استراتيجية ملهمة. نبني أنظمة متطورة لا تكتفي بحل المشكلات، بل تتطور مع طموحاتك المستقبلية.",
    ...
    about_desc: "بصيرة لينس هي نخبة من المهندسين المبدعين، نعمل على تحويل البيانات الخام إلى قوة استراتيجية تدفع أعمالك نحو المستقبل.",
    feature_1_title: "رؤيتنا",
    feature_1_desc: "أن نكون الشريك التقني الرائد في تحويل تعقيدات البيانات إلى قرارات ذكية ومؤثرة.",
    feature_2_title: "مهمتنا",
    feature_2_desc: "تمكين المؤسسات عبر حلول الذكاء الاصطناعي المبتكرة التي تدمج بين الكفاءة العالية والبساطة المتناهية.",
    feature_3_title: "هدفنا",
    feature_3_desc: "تسريع وتيرة التحول الرقمي وبناء مستقبل يرتكز على دقة البيانات وتحقيق النتائج الملموسة.",
    ...
    service_1_desc: "تطوير وكلاء ذكاء اصطناعي قادرة على تنفيذ عمليات معقدة واتخاذ قرارات مستقلة لتعزيز كفاءة العمل.",
    service_1_details: ["سير العمل المعتمد على الوكلاء", "أنظمة الوكلاء المتعددين", "الاستدلال والمنطق المستقل", "تكامل البرمجيات والأدوات"],
    service_2_title: "التحليلات التنبؤية وتعلّم الآلة",
    service_2_desc: "التنبؤ بالتوجهات المستقبلية وسلوك العملاء باستخدام شبكات عصبية ونماذج تعلم آلي متقدمة.",
    service_2_details: ["التنبؤ بالطلب والاحتياجات", "تحليل معدلات انصراف العملاء", "أنظمة كشف الاحتيال", "تصميم البنى العصبية"],
    service_3_title: "الذكاء الاصطناعي التوليدي ومعالجة اللغات",
    service_3_desc: "بناء محركات بحث دلالية ومساعدات ذكية توفر تجربة تفاعلية طبيعية وتحليلاً عميقاً للنصوص.",
    service_3_details: ["أنظمة الدردشة المخصصة", "البحث الدلالي المتقدم", "تحليل مشاعر النصوص", "استخراج البيانات والمعلومات"],
    service_4_title: "الرؤية الحاسوبية والذكاء البصري",
    service_4_desc: "تطوير أنظمة مراقبة وتحليل بصري فوري باستخدام أحدث نماذج التعرف على الأشياء والأنماط.",
    service_4_details: ["التعرف الذكي على الأشياء", "التحليل الحيوي والمكاني", "أنظمة القراءة الآلية (OCR)", "تحليل الفيديو بالوقت الفعلي"],
    service_5_title: "تحليل البيانات المتقدم وذكاء الأعمال",
    service_5_desc: "تحويل البيانات الضخمة إلى رؤى استراتيجية عبر تحليل SPSS، لوحات تحكم تفاعلية، ونمذجة إحصائية احترافية.",
    service_5_details: ["تحليلات الاستبيانات المتقدمة", "الحوسبة الإحصائية (R)", "لوحات البيانات التفاعلية", "صناعة القصة عبر البيانات"],
    service_6_title: "هندسة تطبيقات الويب والأنظمة الذكية",
    service_6_desc: "بناء منصات ويب متكاملة وعالية الأداء مدمجة بسلاسة مع أنظمة الذكاء الاصطناعي لضمان تجربة مستخدم فريدة.",
    service_6_details: ["تطبيقات الويب المخصصة", "دمج الذكاء الاصطناعي", "الأنظمة السحابية الأصلية", "تحسين الأداء والكفاءة"],
    service_pillar: "ركيزة",
    expertise_label: "التخصصات",
    team_badge: "نخبة الخبراء",
    team_title_part1: "فريق العمل",
    team_title_part2: "المبدع",
    team_desc: "مجموعة متميزة من المهندسين والمبتكرين الملتزمين بصياغة مستقبل الحلول الرقمية.",
    contact_badge: "تواصل معنا",
    contact_title_part1: "لنبني معاً",
    contact_title_part2: " مستقبل أعمالك",
    contact_desc: "سواء كنت تسعى لتحقيق فكرة مبتكرة أو تواجه تحدياً تقنياً معقداً، فإن فريق بصيرة جاهز لهندسة نجاحك.",
